...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/Drvolks/MPVKit/releases/download/0.41.0-drvolks.1/Libmpv.xcframework.zip",
            checksum: "68f126a33dd533ca9a54a89de0bdfe2f9da44801f4d106e38b55fffb5f18b185"
        ),
