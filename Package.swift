...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/Drvolks/MPVKit/releases/download/0.41.0-drvolks.5/Libmpv.xcframework.zip",
            checksum: "5f54bb575a7cfb4593b864cbaada992cc1bf71cbaa0eb97481c5879671f61826"
        ),
