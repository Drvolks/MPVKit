...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/Drvolks/MPVKit/releases/download/0.41.0-drvolks.2/Libmpv.xcframework.zip",
            checksum: "241c57807e63e7c0856aa8b26bbaf514b24546299d71a7dc2bef20ee60382441"
        ),
